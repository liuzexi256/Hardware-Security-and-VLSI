...
HD_PWD='E:/axi_soc_soccom/axi_soc_soccom.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_top.tcl
